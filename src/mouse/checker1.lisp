...
(in-package :Lunette.Examples.checker1)
...
(defun WinMain ()
  ...
  (register-class "Checker1Win" :lpfnWndProc (callback WindowFunc))

  (let ((hwnd (create-window-ex "Checker1Win" "Checker1 Mouse Hit-Test Demo")))
